...
object Templates {
    ...
    private fun el(d: FlowDocument, type: ElementType, x: Float, y: Float, label: String, notes: String = ""): FlowElement =
        FlowElement(type = type, x = kotlin.math.round(x / 10f) * 10f, y = kotlin.math.round(y / 10f) * 10f, width = 337.5f, height = 168.75f, label = label, notes = notes).also { d.elements += it }
    ...
    private fun serverRoom(): FlowDocument {
        ...
        val app = el(d, ElementType.SERVER, 150f, 840f, "Application server")
        val db = el(d, ElementType.SERVER, 500f, 840f, "Database server")
        val backup = el(d, ElementType.SERVER, 850f, 840f, "Backup server")
    ...
    private fun homeOfficeNetwork(): FlowDocument {
        ...
        val pc = el(d, ElementType.PROCESS, 50f, 860f, "PCs / laptops")
        val phones = el(d, ElementType.PROCESS, 390f, 860f, "Phones / tablets")
        val printer = el(d, ElementType.PROCESS, 730f, 860f, "Printer")
        val nas = el(d, ElementType.SERVER, 1070f, 860f, "NAS / storage")
    ...
    private fun creative(): FlowDocument {
        ...
        val a = el(d, ElementType.PROCESS, -40f, 580f, "Idea A")
        val b = el(d, ElementType.PROCESS, 320f, 580f, "Idea B")
        val c = el(d, ElementType.PROCESS, 680f, 580f, "Idea C")
        val ideaD = el(d, ElementType.PROCESS, 1040f, 580f, "Idea D")
    ...
    private fun logicalThought(): FlowDocument {
        ...
        val evidence = el(d, ElementType.PROCESS, 150f, 330f, "Evidence")
        val assumptions = el(d, ElementType.PROCESS, 500f, 330f, "Assumptions")
        val counter = el(d, ElementType.PROCESS, 850f, 330f, "Counterexamples")
        ...
        val supported = el(d, ElementType.TERMINAL, 150f, 1180f, "Supported")
        val uncertain = el(d, ElementType.TERMINAL, 500f, 1180f, "Uncertain")
        val rejected = el(d, ElementType.TERMINAL, 850f, 1180f, "Not supported")
    ...
    private fun decisionMaking(): FlowDocument {
        ...
        val a = el(d, ElementType.PROCESS, 150f, 580f, "Option A")
        val b = el(d, ElementType.PROCESS, 500f, 580f, "Option B")
        val c = el(d, ElementType.PROCESS, 850f, 580f, "Option C")
